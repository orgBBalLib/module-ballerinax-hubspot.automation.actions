...
> **Tip:** You must copy and store this key somewhere safe. It won't be visible again after you navigate away for security reasons.
## Quickstart
    ...
    hsactions:PublicActionDefinitionEgg newAction = {
        ...
        labels: {
            "en": {
                ...
                actionDescription: "A sample automation action created via Ballerina"
            }
        },
        inputFields: [
            {
