...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that provides software and tools for marketing, sales, customer service, and content management, helping businesses grow better by connecting with their customers.
...
8. Copy the generated access token from the dialog that appears.
